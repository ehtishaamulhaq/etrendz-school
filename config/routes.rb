Rails.application.routes.draw do
  ...
  match '/courses/update_batch' => 'courses#update_batch', via: [:get, :post]

  get '/courses/manage_course' => 'courses#manage_course'
  get '/courses/manage_batches' => 'courses#manage_batches'

  get '/students/student_register/:id' => 'students#student_register'
  get '/students/attendance_register' => 'students#attendance_register'
  ...
  get '/backup' => 'user#backup'
  # get 'attendances/daily_register'
  get 'attendances/report'
  get 'attendances/update_attendance'
  match 'attendances/filter', :via => [:get, :post]
  get 'attendance_list/:id' => 'attendances#attendance_list'
  get '/attendance_report' => 'attendances#attendance_report'



  get 'list_students_by_course/:id' => 'students#list_students_by_course'
  ...
  # C
    ...
    resources :configuration, :controller=>"settings", only: :index do
      collection do
        get :settings
        post :settings
      end
    ...
    # resources :configuration, :controller=>"settings", :path => "configuration"
  ...
  # E
    ...
    resources :exam_reports, only: :index do
      collection do
        ...
        match :archived_batches_exam_report, :via => [:get, :post]
        post :archived_batches_exam_report_pdf
