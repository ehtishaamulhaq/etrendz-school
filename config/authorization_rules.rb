authorization do
  ...
  role :add_new_batch do
    has_permission_on [:settings], :to => [:index]
  ...
  role :general_settings do
    has_permission_on [:settings], :to => [:index,:settings,:permissions]
  ...
  role :admin do
    ...
    has_permission_on [:settings], :to => [:index,:settings,:permissions, :add_weekly_holidays, :delete]
    has_permission_on [:subjects], :to => [:show_batch,:index, :new, :create,:destroy,:edit,:update, :show]
    has_permission_on [:elective_groups],  :to => [:index,:new,:create,:destroy,:edit, :update,:show]
