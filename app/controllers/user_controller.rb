class UserController < ApplicationController
  ...
  def dashboard
    ...
    if @user.student?
      ...
      @arabic_marks = {'09AY154' => 72, '09AY155' => 68, '09AY156' => 86, '09AY158' => 73, '09AY161' => 92, '09AY166' => 74, '10AY160' => 84, '11AY162' => 66, '11AY163' => 32, '12AY157' => 78, '12AY164' => 28, '12AY165' => 76, '12AY168' => 83}
    end
    if @user.parent?
  ...
  def user_params
    params.require(:user).permit(:username, :first_name, :last_name, :email, :admin, :student, :employee, :password, :hashed_password)
  end
end
